...
function Orderall() {
  ...
  const [select_id_list, setSelect_id_list] = useState<DataType[]>([]);
  ...
  const showDrawer = () => {
    ...
    axiosInstance
      ...
      .then(function (response) {
        ...
        setOrder_date(DataEdit.timestamps);
      });
    ...
    <div >
      ...
      <Row>
        <Col flex="auto">
          <Text style={{ fontSize: 19 }}>
            {" "}
            ออเดอร์รวมทุกช่องทาง {data.length} ออเดอร์
          </Text>
        </Col>
      ...
      <Row>
        <Col flex="auto" style={{ float: "right", margin: 5, }}  >
          วันที่ซื้อ: <DatePicker
            onChange={onChange} size="middle" format={"DD/MM/YYYY"} />
        </Col>
      </Row>
